...
public class ResponseResult<T> implements Serializable {
    ...
    public static ResponseResult errorResult(AppHttpCodeEnum appHttpCodeEnum,String msg){
    ...
    public static ResponseResult setAppHttpCodeEnum(AppHttpCodeEnum appHttpCodeEnum,String msg){
